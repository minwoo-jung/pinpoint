...
@javax.annotation.Generated(value = "Autogenerated by Thrift Compiler (0.10.0)", date = "2018-06-22")
public class TCmdGetAuthenticationToken implements org.apache.thrift.TBase<TCmdGetAuthenticationToken, TCmdGetAuthenticationToken._Fields>, java.io.Serializable, Cloneable, Comparable<TCmdGetAuthenticationToken> {
  ...
  private static final org.apache.thrift.protocol.TField TOKEN_TYPE_FIELD_DESC = new org.apache.thrift.protocol.TField("tokenType", org.apache.thrift.protocol.TType.I32, (short)2);
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetLicenseKey()) ? 131071 : 524287);
    if (isSetLicenseKey())
      hashCode = hashCode * 8191 + licenseKey.hashCode();
  ...
  public int compareTo(TCmdGetAuthenticationToken other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetLicenseKey()).compareTo(other.isSetLicenseKey());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetLicenseKey()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.licenseKey, other.licenseKey);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  private static class TCmdGetAuthenticationTokenStandardScheme extends org.apache.thrift.scheme.StandardScheme<TCmdGetAuthenticationToken> {
        ...
        switch (schemeField.id) {
          case 1: // LICENSE_KEY
            if (schemeField.type == org.apache.thrift.protocol.TType.STRING) {
              struct.licenseKey = iprot.readString();
              struct.setLicenseKeyIsSet(true);
            } else {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TCmdGetAuthenticationToken struct) throws org.apache.thrift.TException {
      ...
      if (struct.licenseKey != null) {
        oprot.writeFieldBegin(LICENSE_KEY_FIELD_DESC);
        oprot.writeString(struct.licenseKey);
        oprot.writeFieldEnd();
      }
