...
public class TFAgentInfo implements org.apache.thrift.TBase<TFAgentInfo, TFAgentInfo._Fields>, java.io.Serializable, Cloneable, Comparable<TFAgentInfo> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TFAgentInfo");
  ...
  static {
    schemes.put(StandardScheme.class, new TFAgentInfoStandardSchemeFactory());
    schemes.put(TupleScheme.class, new TFAgentInfoTupleSchemeFactory());
  }
  ...
  private TFServerMetaData serverMetaData; // optional
  private TFJvmInfo jvmInfo; // optional
  ...
  static {
    ...
    tmpMap.put(_Fields.SERVER_META_DATA, new org.apache.thrift.meta_data.FieldMetaData("serverMetaData", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, TFServerMetaData.class)));
    tmpMap.put(_Fields.JVM_INFO, new org.apache.thrift.meta_data.FieldMetaData("jvmInfo", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, TFJvmInfo.class)));
    metaDataMap = Collections.unmodifiableMap(tmpMap);
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TFAgentInfo.class, metaDataMap);
  }
   ...
   */
  public TFAgentInfo(TFAgentInfo other) {
    ...
    if (other.isSetServerMetaData()) {
      this.serverMetaData = new TFServerMetaData(other.serverMetaData);
    }
    if (other.isSetJvmInfo()) {
      this.jvmInfo = new TFJvmInfo(other.jvmInfo);
    }
  }
  ...
  public void setServerMetaData(TFServerMetaData serverMetaData) {
  ...
  public void setJvmInfo(TFJvmInfo jvmInfo) {
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case SERVER_META_DATA:
      if (value == null) {
        ...
        setServerMetaData((TFServerMetaData)value);
      }
      break;
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof TFAgentInfo)
      return this.equals((TFAgentInfo)that);
    return false;
  }

  public boolean equals(TFAgentInfo that) {
    if (that == null)
      return false;
  ...
  public int hashCode() {
    ...
    boolean present_agentVersion = true && (isSetAgentVersion());
    list.add(present_agentVersion);
    if (present_agentVersion)
      list.add(agentVersion);
    ...
    boolean present_jvmInfo = true && (isSetJvmInfo());
    list.add(present_jvmInfo);
    if (present_jvmInfo)
      list.add(jvmInfo);
  ...
  @Override
  public int compareTo(TFAgentInfo other) {
    ...
    lastComparison = Boolean.valueOf(isSetJvmInfo()).compareTo(other.isSetJvmInfo());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetJvmInfo()) {
  ...
  private static class TFAgentInfoStandardScheme extends StandardScheme<TFAgentInfo> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, TFAgentInfo struct) throws org.apache.thrift.TException {
        ...
        switch (schemeField.id) {
          ...
          case 20: // SERVER_META_DATA
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.serverMetaData = new TFServerMetaData();
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TFAgentInfo struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class TFAgentInfoTupleScheme extends TupleScheme<TFAgentInfo> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TFAgentInfo struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TFAgentInfo struct) throws org.apache.thrift.TException {
