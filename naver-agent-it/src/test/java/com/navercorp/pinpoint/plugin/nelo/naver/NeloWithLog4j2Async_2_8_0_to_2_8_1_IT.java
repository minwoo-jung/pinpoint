...
@Dependency({"org.apache.logging.log4j:log4j-core:[2.8,2.8.1]", "org.apache.logging.log4j:log4j-api:[2.8.1]", "org.apache.logging.log4j:log4j-slf4j-impl:[2.8.1]", "com.naver.nelo2:nelo2-java-sdk-log4j2:[2.8.2]", "com.lmax:disruptor:[3.4.2]"})
...
public class NeloWithLog4j2Async_2_8_0_to_2_8_1_IT {
    @Test
