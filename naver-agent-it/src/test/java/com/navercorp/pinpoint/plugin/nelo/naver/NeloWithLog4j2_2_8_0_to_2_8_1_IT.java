...
@Dependency({"org.apache.logging.log4j:log4j-core:[2.8,2.8.1]", "org.apache.logging.log4j:log4j-api:[2.8.1]", "org.apache.logging.log4j:log4j-slf4j-impl:[2.8.1]", "com.naver.nelo2:nelo2-java-sdk-log4j2:[2.8.2]"})
@JvmArgument("-Dlog4j.configurationFile=com/navercorp/pinpoint/plugin/nelo/naver/log4j2.xml")
@JvmVersion(7)
@PinpointConfig("pinpoint.config")
public class NeloWithLog4j2_2_8_0_to_2_8_1_IT {
    @Test
