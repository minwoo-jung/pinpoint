...
public class CubridJDBCDriverClass extends AbstractJDBCDriverClass {
    ...
    public Class<Connection> getConnection() {
        return forName("cubrid.jdbc.driver.CUBRIDConnection");
    }

    @Override
    public Class<Statement> getStatement() {
        return forName("cubrid.jdbc.driver.CUBRIDStatement");
    }

    @Override
    public Class<PreparedStatement> getPreparedStatement() {
        return forName("cubrid.jdbc.driver.CUBRIDPreparedStatement");
    }
