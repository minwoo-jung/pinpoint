...
@Dependency({ "org.springframework.boot:spring-boot-loader:[1.4.0.RELEASE,2.0.0.RELEASE)" })
@TestAppVersion(TestAppSpringBootVersion.POST_1_4)
public class SpringBootWarLauncher_1_4_X_to_2_0_0_IT extends WarLauncherItBase {
    ...
    public void testBootstrap() {
        ...
        List<String> expectedLibs = new ExpectedLibraries()
                // 1.4.x WarLauncher removes the root of the war file from the classpath.
