 ...
 * @author emeroad
 */
public class ScopedInterceptor4 implements AroundInterceptor4 {
    ...
    public ScopedInterceptor4(AroundInterceptor4 interceptor, InterceptorScope scope, ExecutionPolicy policy) {
        if (interceptor == null) {
