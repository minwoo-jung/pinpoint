...
import static com.navercorp.pinpoint.plugin.bloc.BlocPlugin.*;
 ...
 *
 */
public class BlocServiceTypes implements ServiceTypeProvider {
    ...
    public ServiceType[] getServiceTypes() {
        return new ServiceType[] { BLOC, BLOC_INTERNAL_METHOD };
    }

    @Override
    public AnnotationKey[] getAnnotationKeys() {
        return new AnnotationKey[] { CALL_URL, CALL_PARAM, PROTOCOL };
    }
}
