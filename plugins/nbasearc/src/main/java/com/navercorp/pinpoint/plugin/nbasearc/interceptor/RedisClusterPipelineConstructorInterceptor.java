 ...
 *
 */
public class RedisClusterPipelineConstructorInterceptor implements SimpleAroundInterceptor, NbaseArcConstants {
    ...
    public RedisClusterPipelineConstructorInterceptor(TraceContext traceContext, @Cached MethodDescriptor methodDescriptor, @Name(METADATA_DESTINATION_ID) MetadataAccessor destinationIdAccessor,
