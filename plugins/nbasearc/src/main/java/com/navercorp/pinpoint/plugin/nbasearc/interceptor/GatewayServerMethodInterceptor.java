...
/**
 * GatewayServer(nBase-ARC client) getResource() method interceptor - trace destinationId
 * 
 * @author jaehong.kim
 *
 */
public class GatewayServerMethodInterceptor implements SimpleAroundInterceptor, NbaseArcConstants {
    private final PLogger logger = PLoggerFactory.getLogger(this.getClass());
    private final boolean isDebug = logger.isDebugEnabled();

    private final MetadataAccessor destinationIdAccessor;

    public GatewayServerMethodInterceptor(TraceContext traceContext, @Cached MethodDescriptor methodDescriptor, @Name(METADATA_DESTINATION_ID) MetadataAccessor destinationIdAccessor) {
