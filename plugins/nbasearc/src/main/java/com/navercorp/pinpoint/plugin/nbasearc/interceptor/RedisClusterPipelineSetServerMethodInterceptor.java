...
public class RedisClusterPipelineSetServerMethodInterceptor extends GatewayServerMetadataReadInterceptor {
    ...
    public RedisClusterPipelineSetServerMethodInterceptor(TraceContext traceContext, MethodDescriptor methodDescriptor, MetadataAccessor destinationIdAccessor, MetadataAccessor endPointAccessor) {
