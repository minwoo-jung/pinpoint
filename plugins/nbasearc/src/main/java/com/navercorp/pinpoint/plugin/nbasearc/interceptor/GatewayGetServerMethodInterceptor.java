...
public class GatewayGetServerMethodInterceptor extends GatewayServerMetadataAttachInterceptor {
    ...
    public GatewayGetServerMethodInterceptor(TraceContext traceContext, @Cached MethodDescriptor methodDescriptor, @Name(METADATA_DESTINATION_ID) MetadataAccessor destinationIdAccessor) {
