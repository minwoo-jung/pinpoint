 ...
 *
 */
public class RedisConnectionConstructorInterceptor implements SimpleAroundInterceptor, NbaseArcConstants {
    ...
    public RedisConnectionConstructorInterceptor(TraceContext traceContext, @Cached MethodDescriptor methodDescriptor, @Name(METADATA_END_POINT) MetadataAccessor endPointAccessor) {
