package com.navercorp.pinpoint.profiler.modifier.connector.nimm;
...
public class NimmInvokerModifier extends AbstractModifier {
	...
	public byte[] modify(ClassLoader classLoader, String javassistClassName, ProtectionDomain protectedDomain, byte[] classFileBuffer) {
		...
		try {
			...
			// constructor
			Interceptor constructorInterceptor = byteCodeInstrumentor.newInterceptor(classLoader, protectedDomain, "com.navercorp.pinpoint.profiler.modifier.connector.nimm.interceptor.NimmInvokerConstructorInterceptor");
			...
			// invoke method
			Interceptor invokeInterceptor = byteCodeInstrumentor.newInterceptor(classLoader, protectedDomain, "com.navercorp.pinpoint.profiler.modifier.connector.nimm.interceptor.InvokeMethodInterceptor");
