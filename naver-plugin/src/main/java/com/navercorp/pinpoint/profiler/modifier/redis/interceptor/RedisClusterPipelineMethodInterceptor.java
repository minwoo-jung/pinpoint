 ...
 *
 */
public class RedisClusterPipelineMethodInterceptor extends SpanEventSimpleAroundInterceptor implements TargetClassLoader {

    public RedisClusterPipelineMethodInterceptor() {
