 ...
 *
 */
public class RedisClusterPipelineSetServerMethodInterceptor implements SimpleAroundInterceptor, TargetClassLoader {
    ...
    public void before(Object target, Object[] args) {
        ...
        if (!(target instanceof MapTraceValue) || args == null || args.length < 1 || !(args[0] instanceof GatewayServer)) {
            return;
        }
