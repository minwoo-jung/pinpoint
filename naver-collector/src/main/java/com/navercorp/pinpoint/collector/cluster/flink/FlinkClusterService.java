...
public class FlinkClusterService {
    ...
    private final NaverCollectorConfiguration config;
    ...
    public FlinkClusterService(NaverCollectorConfiguration config, FlinkClusterConnectionManager clusterConnectionManager) {
        this.config = config;
