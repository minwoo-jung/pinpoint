...
/**
 * Copied from com.navercorp.pinpoint.web.vo.role.RoleInformation
 *
...
public class RoleInformation {
    ...
    public static final RoleInformation ADMIN_ROLE = new RoleInformation("admin", PermissionCollection.ADMIN);
    public static final RoleInformation UNASSIGNED_ROLE = new RoleInformation("Unassined_role", PermissionCollection.DEFAULT);
