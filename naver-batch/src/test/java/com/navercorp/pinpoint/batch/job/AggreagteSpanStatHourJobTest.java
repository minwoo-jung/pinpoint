 ...
 * @author minwoo.jung
 */
public class AggreagteSpanStatHourJobTest {

    public static void main(String[] args) throws Exception{
        GenericXmlApplicationContext applicationContext = new GenericXmlApplicationContext("/applicationContext-test.xml", "/batch/insertAggregateSpanStatHour.xml");
