 ...
 * @author minwoo.jung
 */
public class AggregateSpanStatDayJobTest {

    public static void main(String[] args) throws Exception{
        GenericXmlApplicationContext applicationContext = new GenericXmlApplicationContext("/applicationContext-test.xml", "/batch/insertAggregateSpanStatDay.xml");
