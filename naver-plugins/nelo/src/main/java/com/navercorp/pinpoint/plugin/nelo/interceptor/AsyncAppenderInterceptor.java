 ...
 * @author minwoo.jung
 */
public class AsyncAppenderInterceptor implements AroundInterceptor0 {

    private final TraceContext traceContext;

    public AsyncAppenderInterceptor(TraceContext traceContext) {
        this.traceContext = traceContext;
    }

    @Override
    public void before(Object target) {
        if ((target instanceof UsingNeloAppenderAccessor) == false) {
            return;
        }
