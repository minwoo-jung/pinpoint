 ...
 * @author jaehong.kim
 */
public class JeusAsyncListener implements AsyncListener {
    ...
    public JeusAsyncListener(final TraceContext traceContext, final AsyncContext asyncContext) {
    ...
    public void onError(AsyncEvent asyncEvent) throws IOException {
        if (isDebug) {
            logger.debug("Error asynchronous operation. event={}, response={}", asyncEvent, asyncEvent.getSuppliedResponse());
        }
