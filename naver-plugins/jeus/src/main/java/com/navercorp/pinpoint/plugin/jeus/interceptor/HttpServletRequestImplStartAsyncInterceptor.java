...
import com.navercorp.pinpoint.plugin.jeus.JeusAsyncListener;
    ...
    public void after(Object target, Object[] args, Object result, Throwable throwable) {
        ...
        try {
            ...
            if (validate(target, result, throwable)) {
                ...
                request.setAttribute(JeusConstants.JEUS_ASYNC_OPERATION, Boolean.TRUE);
                if (isDebug) {
                    logger.debug("Set request attribute {}={}", JeusConstants.JEUS_ASYNC_OPERATION, Boolean.TRUE);
                }

                final AsyncContext asyncContext = (AsyncContext) result;
                final AsyncListener asyncListener = new JeusAsyncListener(this.traceContext, recorder.recordNextAsyncContext(true));
