 ...
 * @author jaehong.kim
 */
public class OwfsPluginConstants {

    public static final ServiceType OWFS = ServiceTypeFactory.of(8260, "OWFS", TERMINAL, RECORD_STATISTICS, INCLUDE_DESTINATION_ID);
}
