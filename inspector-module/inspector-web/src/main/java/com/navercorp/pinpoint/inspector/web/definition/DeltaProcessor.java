...
public class DeltaProcessor implements PostProcessor {
    ...
    public List<SystemMetricPoint<Double>> postProcess(List<SystemMetricPoint<Double>> systemMetricPointList) {
        ...
        postProcessedList.add(new SystemMetricPoint<Double>(prevPoint.getXVal(), 0.0));
        ...
        for (int i = 1; i < systemMetricPointList.size(); i++) {
            ...
            SystemMetricPoint<Double> deltaSystemMetricPoint = new SystemMetricPoint<Double>(currentPoint.getXVal(), deltaValue);
