...
public class InspectorMetricGroupDataVeiw {
    ...
    public List<MetricValueGroupView> getMetricValueGroups() {
        Map<List<Tag>, List<MetricValue<Double>>> metricValueGroups = inspectorMetricGroupData.getMetricValueGroups();

        List<MetricValueGroupView> metricValueGroupViewList= new ArrayList<>(metricValueGroups.size());

        for (Map.Entry<List<Tag>, List<MetricValue<Double>>> entry : metricValueGroups.entrySet()) {
    ...
    public static class MetricValueGroupView {
        ...
        public MetricValueGroupView(List<Tag> tags, List<MetricValue<Double>> metricValues) {
    ...
    public static class MetricValueView {
        ...
        public MetricValueView(MetricValue<Double> metricValue) {
