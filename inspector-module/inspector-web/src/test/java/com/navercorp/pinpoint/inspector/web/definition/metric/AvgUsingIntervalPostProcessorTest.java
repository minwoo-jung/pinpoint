...
class AvgUsingIntervalPostProcessorTest {
    ...
    public void postProcessTest() {
        ...
        List<MetricValue<Double>> metricValueList = new ArrayList<>();
        ...
        MetricValue sampledNewCount = new MetricValue<>("sampledNewCount", Collections.emptyList(), sampledNewCountValueList);
        ...
        MetricValue sampledContinuationCount = new MetricValue<>("sampledContinuationCount", Collections.emptyList(), sampledContinuationCountValueList);
        ...
        MetricValue unsampledNewCount = new MetricValue<>("unsampledNewCount", Collections.emptyList(), unsampledNewCountValueList);
        ...
        MetricValue unsampledContinuationCount = new MetricValue<>("unsampledContinuationCount", Collections.emptyList(), unsampledContinuationCountValueList);
        ...
        MetricValue skippedNewSkipCount = new MetricValue<>("skippedNewSkipCount", Collections.emptyList(), skippedNewSkipCountValueList);
        ...
        MetricValue skippedContinuationCount = new MetricValue<>("skippedContinuationCount", Collections.emptyList(), skippedContinuationCountValueList);
        ...
        MetricValue collectInterval = new MetricValue<>("collectInterval", Collections.emptyList(), collectIntervalValueList);
        metricValueList.add(collectInterval);

        List<MetricValue<Double>> processedValuesList = avgUsingIntervalPostProcessor.postProcess(metricValueList);
        assertEquals(7, processedValuesList.size());


        Map<String, MetricValue<Double>> processedValuesMap = processedValuesList.stream().collect(Collectors.toMap(MetricValue::getFieldName, Function.identity()));
