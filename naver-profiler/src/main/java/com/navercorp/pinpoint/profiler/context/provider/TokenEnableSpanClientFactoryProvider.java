 ...
 * @author Taejin Koo
 */
public class TokenEnableSpanClientFactoryProvider extends AbstractClientFactoryProvider implements Provider<PinpointClientFactory> {
    ...
    @Inject
    public TokenEnableSpanClientFactoryProvider(ProfilerConfig profilerConfig, @TokenEnableConnectionFactoryProvider ConnectionFactoryProvider connectionFactoryProvider,
