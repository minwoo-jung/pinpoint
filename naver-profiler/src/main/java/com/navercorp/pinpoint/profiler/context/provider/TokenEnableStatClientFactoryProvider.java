 ...
 * @author Taejin Koo
 */
public class TokenEnableStatClientFactoryProvider extends AbstractClientFactoryProvider implements Provider<PinpointClientFactory> {
    ...
    @Inject
    public TokenEnableStatClientFactoryProvider(ProfilerConfig profilerConfig, @TokenEnableConnectionFactoryProvider ConnectionFactoryProvider connectionFactoryProvider,
                                                @SpanStatChannelFactory Provider<ChannelFactory> channelFactoryProvider, @SpanStatConnectTimer Provider<Timer> spanStatConnectTimer) {
    ...
    public PinpointClientFactory get() {
        ...
        PinpointClientFactory pinpointClientFactory = new DefaultPinpointClientFactory(channelFactoryProvider.get(), spanStatConnectTimer.get(), connectionFactoryProvider);
