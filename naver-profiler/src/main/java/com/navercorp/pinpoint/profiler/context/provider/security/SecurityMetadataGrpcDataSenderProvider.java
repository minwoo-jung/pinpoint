 ...
 * @author Taejin Koo
 */
public class SecurityMetadataGrpcDataSenderProvider implements Provider<EnhancedDataSender<Object>> {
    ...
    public EnhancedDataSender<Object> get() {
        ...
        final ChannelFactoryBuilder channelFactoryBuilder = newChannelFactory();
    ...
    private ChannelFactoryBuilder newChannelFactory() {
        ...
        final ChannelFactoryBuilder channelFactoryBuilder = new DefaultChannelFactoryBuilder("MetadataGrpcDataSender");
