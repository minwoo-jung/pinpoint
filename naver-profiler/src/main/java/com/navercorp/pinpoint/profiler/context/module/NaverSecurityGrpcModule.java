...
import com.navercorp.pinpoint.profiler.context.provider.security.SecurityStatGrpcDataSenderProvider;
...
public class NaverSecurityGrpcModule extends PrivateModule {
    ...
    protected void configure() {
        ...
        bind(spanDataSender).toProvider(SecuritySpanGrpcDataSenderProvider.class).in(Scopes.SINGLETON);
        ...
        bind(DataSender.class).annotatedWith(StatDataSender.class).toProvider(SecurityStatGrpcDataSenderProvider.class).in(Scopes.SINGLETON);
