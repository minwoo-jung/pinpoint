...
import com.navercorp.pinpoint.testweb.service.thrift.EchoService;
import com.navercorp.pinpoint.testweb.service.thrift.EchoService.AsyncClient.echo_call;
import com.navercorp.pinpoint.testweb.service.thrift.EchoService.AsyncClient.unexisting_call;
    ...
    public String errorApiAsync() throws IOException {
        ...
        try {
            ...
            AsyncMethodCallback<EchoService.AsyncClient.unexisting_call> callback = new AsyncMethodCallback<EchoService.AsyncClient.unexisting_call>() {
                @Override
                public void onComplete(unexisting_call response) {
                    try {
                        response.getResult();
                    } catch (TException e) {
                        // do nothing
