 ...
 */
@Service("hystrixObservableCommandToObservableService")
public class HystrixObservableCommandToObservableService extends HystrixObservableService<Member> {
    ...
    protected Observable<Member> getMembers(HystrixMemberService hystrixMemberService, List<Integer> memberIds) {
        ...
        return getMembersObservableCommand.toObservable();
    }
