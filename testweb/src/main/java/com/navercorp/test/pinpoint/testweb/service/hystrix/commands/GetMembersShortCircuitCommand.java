 ...
 */
public class GetMembersShortCircuitCommand extends GetMembersCommand {

    private static final String COMMAND_GROUP = "GetMembersShortCircuit";

    public GetMembersShortCircuitCommand(HystrixMemberService hystrixMemberService, List<Integer> memberIds) {
