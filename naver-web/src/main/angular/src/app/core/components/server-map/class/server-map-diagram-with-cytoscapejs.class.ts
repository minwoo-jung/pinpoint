...
export class ServerMapDiagramWithCytoscapejs extends ServerMapDiagram {
    ...
    private bindEvent(): void {
        this.cy.on('layoutready', () => {
            if (!this.isNodeInDiagram(this.baseApplicationKey)) {
                this.baseApplicationKey = this.getUnAuthorizedKeyFormat(this.baseApplicationKey);
            }
    ...
    private getUnAuthorizedKeyFormat(key: string): string {
        // Replace it with ApplicationName^UNAUTHORIZED
