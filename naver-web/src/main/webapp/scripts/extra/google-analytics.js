...
if (typeof wcs.norefresh == "undefined") {
    ...
    var R = {}, o = "0.4.28",
        ...
        p = k.appVersion,
        c = k.userAgent,
        H = (ai == "Microsoft Internet Explorer"),
        f = (p.indexOf("Opera") >= 0),
        E = (c.indexOf("MAC") >= 0),
        au = 0,
        u = -1,
        ...
        i = (av.protocol == "https:") ? "https:" : "http:",
        ag = "NA_SA",
        af = "NA_SAC",
        ad = "NA_SAS",
        Q = "NA_MI",
    ...
    function V() {
        try {
            R.bw = document.documentElement.clientWidth ? document.documentElement.clientWidth : document.body.clientWidth;
            R.bh = document.documentElement.clientHeight ? document.documentElement.clientHeight : document.body.clientHeight
        } catch (ax) {}
    }
    ...
    function r() {
        ...
        if (window.screen) {
            ...
            if (window.java || self.java) {
                var ax = java.awt.Toolkit.getDefaultToolkit().getColorModel().getPixelSize();
                R.c = ax
            }
        }
    }
                ...
                if (aE[aO].indexOf(":") >= 0) {
                    ...
                    for (var aP in ax) {
                        if (Object.prototype.hasOwnProperty.call(ax, aP)) {
                            ...
                            var aJ = 0;
                            for (var ay in aN) {
                                if (Object.prototype.hasOwnProperty.call(aN, ay)) {
                                    if (aJ == 0) {
                                        aR = aN[ay]
                                    } else {
                                        if (aJ == 1) {
    ...
    function ae(aB, aA, ax, ay, az) {
        document.cookie = aB + "=" + aA + ((!ay) ? "" : "; expires=" + ay) + "; path=" + ((!az) ? "/" : az) + ((!ax) ? "" : "; domain=" + ax)
    }
    ...
    if (!h) {
        ...
        if (typeof Date.prototype.toJSON !== "function") {
            Date.prototype.toJSON = function(aG) {
                var aH = ((!(typeof this.valueOf == "undefined")) && isFinite(this.valueOf())) ? this.getUTCFullYear() + "-" + aA(this.getUTCMonth() + 1) + "-" + aA(this.getUTCDate()) + "T" + aA(this.getUTCHours()) + ":" + aA(this.getUTCMinutes()) + ":" + aA(this.getUTCSeconds()) + "Z" : null;
                return aH
            };
            if (!(typeof this.valueOf == "undefined")) {
                String.prototype.toJSON = Number.prototype.toJSON = Boolean.prototype.toJSON = function(aG) {
                    return this.valueOf()
                }
            }
        }
        var az = /[\u0000\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g,
            aC = /[\\\"\x00-\x1f\x7f-\x9f\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g,
            aD, ay, aF = {
                "\b": "\\b",
                "\t": "\\t",
                "\n": "\\n",
        ...
        function ax(aG) {
            aC.lastIndex = 0;
            return aC.test(aG) ? '"' + aG.replace(aC, function(aH) {
                var aI = aF[aH];
                return typeof aI === "string" ? aI : "\\u" + ("0000" + aH.charCodeAt(0).toString(16)).slice(-4)
            }) + '"' : '"' + aG + '"'
        }

        function aB(aN, aK) {
            var aI, aH, aO, aG, aL = aD,
                aJ, aM = aK[aN];
        ...
        if (typeof h.stringify !== "function") {
            h.stringify = function(aJ, aH, aI) {
                ...
                aE = aH;
                if (aH && typeof aH !== "function" && (typeof aH !== "object" || typeof aH.length !== "number")) {
    ...
    var am = {
        ...
        encode: function(az) {
            ...
            while (ay < az.length) {
                ...
                ax = ax + this._keyStr.charAt(aF) + this._keyStr.charAt(aD) + this._keyStr.charAt(aB) + this._keyStr.charAt(aA)
            }
            return ax
        },
        decode: function(az) {
            ...
            while (aA < ax.length) {
                ...
                if (aC < 128) {
                    ...
                    if ((aC > 191) && (aC < 224)) {
                        ...
                        ay += String.fromCharCode(((aC & 15) << 12) | ((az & 63) << 6) | (c3 & 63));
                        aA += 3
                    }
                }
            }
    ...
    function J(aD, aC) {
        ...
        for (aB in aD) {
            var aA = typeof aB;
            var az = typeof aD[aB];
            if ((aA == "string" && aB.length >= 3 && az != "function") || aB == "qy") {
                if (az == "string") {
                    ax.push("&" + aB + "=" + q(aD[aB]))
                } else {
                    if (az == "object") {
    ...
    wcs.event = function(ax, az) {
        var aA = [];
        var ay;
        if (ax == "" || az == "" || typeof ax == "undefined" || typeof az == "undefined") {
            return
        }
    ...
    function M(aB, aL) {
        ...
        aG.push("cnvType=" + aB);
        aG.push("cnvValue=" + aL);
        if (aM.indexOf("D") >= 0 || aM.indexOf("I") >= 0 || aM.indexOf("C") >= 0) {
            az = aG.join("|")
        }
    ...
    function D(ay, aE) {
        ...
        if (!ay) {
            for (var aA = 0; aA < j.length; aA++) {
                if ((j.charCodeAt(aA) > 12592 && j.charCodeAt(aA) < 12687) || (j.charCodeAt(aA) >= 44032 && j.charCodeAt(aA) <= 55203)) {
                    al(Q, "", aE);
                    return true
                }
            }
    ...
    function e(aG) {
        ...
        if (!aG) {
            ...
            if (aD) {
                ...
                ncisy_napm = q("tr=" + aB.tr + "|et=" + aB.et + "|ba=" + aB.ba + "|aa=" + aB.aa + "|ci=" + aB.ci + "|ct=" + aB.ct + "|hk=" + aB.hk)
            } else {
                if (aA) {
                    ay = x(aA);
                    if (ay.e) {
                ...
                if (!ar(aC, ax, aF)) {
                    if (aD) {
                        if ((typeof aB != "undefined") && K(aB.tr) && K(aB.et) && K(aB.ba) && K(aB.aa) && K(aB.ci) && K(aB.ct) && K(aB.hk)) {
                            an(aG, ncisy_napm, aI)
                        }
                    } else {
                        if (aA) {
    ...
    function A(aG) {
        ...
        if (aE) {
            ...
            if (aD) {
                aC = x(aD);
                ax = q("ct=" + aC.ct + "|ci=" + aC.ci + "|tr=" + aC.tr + "|sn=" + aC.sn + "|hk=" + aC.hk)
            }
            if (C.indexOf(ay) >= 0) {
        ...
        if (ay) {
            ...
            if (ay == "naver_influx") {
                ...
                if (ax.sn && ax.ct && ax.ci && ax.hk) {
                    return "&sn=" + ax.sn + "&st=" + ax.ct + "&si=" + ax.ci + "&hk=" + ax.hk
                }
            }
        }
        return false
    ...
    function F(ax) {
        ...
        if (ay) {
            napmObj = x(ay);
            aB = q("ct=" + napmObj.ct + "|ci=" + napmObj.ci + "|tr=" + napmObj.tr + "|hk=" + napmObj.hk + "|trx=" + napmObj.trx);
            ao(ax, aB, aA)
        } else {
            aB = X();
            if (aB && !B("c")) {
