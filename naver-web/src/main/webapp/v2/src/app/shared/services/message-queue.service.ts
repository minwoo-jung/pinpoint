...
export enum MESSAGE_TO {
    ...
    ROLE_INFO_REMOVE_SELECT_ROLE = 'ROLE_INFO_REMOVE_SELECT_ROLE',
    ROLE_INFO_REMOVED = 'ROLE_INFO_REMOVED',
    ROLE_INFO_CREATE_ROLE = 'ROLE_INFO_CREATE_ROLE',
    ROLE_INFO_CREATED = 'ROLE_INFO_CREATED',
    ...
    FAVORITE_APP_LIST_FROM_SERVER = 'FAVORITE_APP_LIST_FROM_SERVER'
}
