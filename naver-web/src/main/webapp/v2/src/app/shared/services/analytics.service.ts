...
export enum TRACKED_EVENT_LIST {
    ...
    CLICK_YOBI_LINK = 'Click Yobi Link',
    ...
    SEARCH_USER_IN_USER_GROUP = 'Search User in User Group',
    RELOAD_USER_LIST_IN_USER_GROUP = 'Reload User List in User Group',
    CREATE_USER_IN_USER_GROUP = 'Create User in User Group',
    UPDATE_USER_IN_USER_GROUP = 'Update User in User Group',
    REMOVE_USER_IN_USER_GROUP = 'Remove User in User Group',
    ...
    CLICK_MORE_ON_APPLICATION_AUTH_AND_ALARM_INFO = 'Click "More" on Application Auth and Alarm Info',
    CLICK_DETAIL_ON_APPLICATION_AUTH_AND_ALARM_INFO = 'Click "Detail" on Application Auth and Alarm Info',
    SHOW_USER_CREATION_FORM = 'Show User Creation Form',
    SHOW_USER_UPDATE_FORM = ' Show User Update Form',
    SHOW_USER_REMOVE_CONFIRM_VIEW = 'Show User Remove Confirm View',
    UPDATE_USER_PROFILE = 'Update User Profile',
    UPDATE_USER_PASSWORD = 'Update User Password',
    UPDATE_USER_ROLE = 'Update User Role',
    RELOAD_USER_LIST_IN_USERS = 'Reload User List in Users',
    CREATE_USER_IN_USERS = 'Create User in Users',
    REMOVE_USER_IN_USERS = 'Remove User in Users',
    SEARCH_USER_IN_USERS = 'Search User in Uses',
    SHOW_ROLE_CREATION_VIEW = 'Show Role Creation View',
    SHOW_ROLE_UPDATE_VIEW = 'Show Role Update View',
    SHOW_ROLE_REMOVE_CONFIRM_VIEW = 'Show Role Remove Confirm View',
    ...
    SHOW_AUTH_CREATION_POPUP = 'Show Auth Creation Popup',
    SHOW_AUTH_UPDATE_POPUP = 'Show Auth Update Popup',
