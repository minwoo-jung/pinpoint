...
public class ActiveTraceDaoCompatibilityTest extends HbaseAgentStatDaoCompatibilityTestBase<ActiveTraceBo> {

    @Autowired
    @Qualifier("activeTraceDaoV1")
    private ActiveTraceDao v1Dao;

    @Autowired
    @Qualifier("activeTraceDaoV2")
    private ActiveTraceDao v2Dao;
