...
public class SampledActiveTraceDaoCompatibilityTest extends SampledHbaseAgentStatDaoCompatibilityTestBase<SampledActiveTrace> {

    @Autowired
    @Qualifier("sampledActiveTraceDaoV1")
    private SampledActiveTraceDao v1Dao;

    @Autowired
    @Qualifier("sampledActiveTraceDaoV2")
    private SampledActiveTraceDao v2Dao;
