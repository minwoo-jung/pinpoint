...
public class SampledTransactionDaoCompatibilityTest extends SampledHbaseAgentStatDaoCompatibilityTestBase<SampledTransaction> {

    @Autowired
    @Qualifier("sampledTransactionDaoV1")
    private SampledTransactionDao v1Dao;

    @Autowired
    @Qualifier("sampledTransactionDaoV2")
    private SampledTransactionDao v2Dao;
