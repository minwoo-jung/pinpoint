...
public class SampledJvmGcDaoCompatibilityTest extends SampledHbaseAgentStatDaoCompatibilityTestBase<SampledJvmGc> {

    @Autowired
    @Qualifier("sampledJvmGcDaoV1")
    private SampledJvmGcDao v1Dao;

    @Autowired
    @Qualifier("sampledJvmGcDaoV2")
    private SampledJvmGcDao v2Dao;
