...
public class SampledCpuLoadDaoCompatibilityTest extends SampledHbaseAgentStatDaoCompatibilityTestBase<SampledCpuLoad> {

    @Autowired
    @Qualifier("sampledCpuLoadDaoV1")
    private SampledCpuLoadDao v1Dao;

    @Autowired
    @Qualifier("sampledCpuLoadDaoV2")
    private SampledCpuLoadDao v2Dao;
