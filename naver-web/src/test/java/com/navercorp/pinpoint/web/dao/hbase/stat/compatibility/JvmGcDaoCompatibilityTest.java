...
public class JvmGcDaoCompatibilityTest extends HbaseAgentStatDaoCompatibilityTestBase<JvmGcBo> {

    @Autowired
    @Qualifier("jvmGcDaoV1")
    private JvmGcDao v1Dao;

    @Autowired
    @Qualifier("jvmGcDaoV2")
    private JvmGcDao v2Dao;
