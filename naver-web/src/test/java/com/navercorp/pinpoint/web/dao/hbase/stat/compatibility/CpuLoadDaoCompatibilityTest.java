...
public class CpuLoadDaoCompatibilityTest extends HbaseAgentStatDaoCompatibilityTestBase<CpuLoadBo> {

    @Autowired
    @Qualifier("cpuLoadDaoV1")
    private CpuLoadDao v1Dao;

    @Autowired
    @Qualifier("cpuLoadDaoV2")
    private CpuLoadDao v2Dao;
